...
export default function Map({
  ...
  const tileLayerRef = useRef<ReturnType<
    typeof import("leaflet")["tileLayer"]
  > | null>(null);
  const markerRef = useRef<ReturnType<
    typeof import("leaflet")["marker"]
  > | null>(null);
  ...
  useEffect(() => {
    ...
    import("leaflet").then((L) => {
      ...
      tileLayerRef.current = tile as unknown as ReturnType<
        typeof import("leaflet")["tileLayer"]
      >;
  ...
  const handleThemeChange = useCallback(async (theme: MapTheme) => {
    ...
    if (tileLayerRef.current) {
      map.removeLayer(
        tileLayerRef.current as unknown as import("leaflet").Layer,
      );
    }
    ...
    tileLayerRef.current = newTile as unknown as ReturnType<
      typeof import("leaflet")["tileLayer"]
    >;
  }, []);
  ...
  const handleSelect = useCallback(async (result: SearchResult) => {
    ...
    markerRef.current = marker as unknown as ReturnType<
      typeof import("leaflet")["marker"]
    >;
